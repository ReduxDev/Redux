...
{
    QString CSS = "body {font-size:12px; color:#cac5c5; bgcolor:#222222;}\n a, span { font-family: monospace; }\n span.addr {color:#cac5c5; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #222222;}\n td.d0 {font-weight: bold; color:#cac5c5;}\n h2, h3 { white-space:nowrap; color:#22222;}\n a { color:#f15a25; text-decoration:none; }\n a.nav {color:#49545e;}\n";
